        ...
        <div className="box d-flex flex-column flex-md-row p-5 justify-content-center shadow">
          <form action="/addUser" method="post">
              <div className="d-flex flex-column">
                  <h1>Sign Up</h1>
                  <input className='my-2 p-1' type="text" name="firstName" placeholder="First Name" />
                  <input className='my-2 p-1' type="text" name="lastName" placeholder="Last Name" />
                  <input className='my-2 p-1' type="text" name="mobile" placeholder="Mobile No." />
                  ...
                  <input className='my-2 p-1' type="password" name="cpassword" placeholder="Confirm Password" />
