            ...
            <div className="timeline-container">
              ...
              <div className="event">
                ...
                <Row className="mt-3">
                  <Col>
                  <ul>
                    <li>Seated dumbbell shoulder press – 4 sets of 12 reps</li>
                    <li>Standing barbell military press – 4 sets of 10 -12 reps</li>
                    <li>Dumbbell lateral raises – 4 sets of 12 repsDumbbell lateral raises – 4 sets of 12 reps</li>
